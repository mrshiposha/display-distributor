// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.login1 -p /org/freedesktop/login1`, see https://github.com/diwic/dbus-rs
use dbus;
...
pub trait OrgFreedesktopLogin1Manager {
    ...
    fn halt_with_flags(&self, flags: u64) -> Result<(), dbus::Error>;
    fn suspend(&self, interactive: bool) -> Result<(), dbus::Error>;
    fn suspend_with_flags(&self, flags: u64) -> Result<(), dbus::Error>;
    fn hibernate(&self, interactive: bool) -> Result<(), dbus::Error>;
    fn hibernate_with_flags(&self, flags: u64) -> Result<(), dbus::Error>;
    fn hybrid_sleep(&self, interactive: bool) -> Result<(), dbus::Error>;
    fn hybrid_sleep_with_flags(&self, flags: u64) -> Result<(), dbus::Error>;
    fn suspend_then_hibernate(&self, interactive: bool) -> Result<(), dbus::Error>;
    fn suspend_then_hibernate_with_flags(&self, flags: u64) -> Result<(), dbus::Error>;
    ...
    fn handle_power_key_long_press(&self) -> Result<String, dbus::Error>;
    fn handle_reboot_key(&self) -> Result<String, dbus::Error>;
    fn handle_reboot_key_long_press(&self) -> Result<String, dbus::Error>;
    fn handle_suspend_key(&self) -> Result<String, dbus::Error>;
    fn handle_suspend_key_long_press(&self) -> Result<String, dbus::Error>;
    fn handle_hibernate_key(&self) -> Result<String, dbus::Error>;
    fn handle_hibernate_key_long_press(&self) -> Result<String, dbus::Error>;
    ...
    fn stop_idle_session_usec(&self) -> Result<u64, dbus::Error>;
}
...
impl arg::ReadAll for OrgFreedesktopLogin1ManagerPrepareForShutdown {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopLogin1ManagerPrepareForShutdown { start: i.read()? })
    }
}
...
impl arg::ReadAll for OrgFreedesktopLogin1ManagerPrepareForSleep {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopLogin1ManagerPrepareForSleep { start: i.read()? })
    }
}
    ...
    for blocking::Proxy<'a, C>
{
    ...
    fn attach_device(
        ...
        self.method_call(
            "org.freedesktop.login1.Manager",
            "AttachDevice",
            (seat_id, sysfs_path, interactive),
        )
    }
    ...
    fn halt_with_flags(&self, flags: u64) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "HaltWithFlags", (flags,))
    }
